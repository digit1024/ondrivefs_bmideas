...
use crate::{
    ...
    persistency::database::{ProcessingItem, ProcessingItemRepository, SyncStateRepository},
...
impl SyncCycle {
    ...
    pub async fn run(&self) -> Result<()> {
        let processing_repo =
            ProcessingItemRepository::new(self.app_state.persistency_manager.pool().clone());
        let folders_to_download = self
            .app_state
            .project_config
            .settings
            .download_folders
