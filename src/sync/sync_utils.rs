...
mod tests {
    ...
    #[test]
    fn test_should_sync_item_with_sync_folders() {
    ...
    #[test]
    fn test_should_sync_item_without_sync_folders() {
        let cache_dir = PathBuf::from("/cache");
        let sync_folders = vec![];
        
        // Should sync everything when no sync folders specified
